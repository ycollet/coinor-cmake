...
add_coin_vol_test(miplib2000_30n20b8_mps_vol_standard osi_vol
                  ${VOL_INSTANCES_DIR}/30n20b8.mps.gz)
...
create_log_analysis(miplib2000_30n20b8_mps_vol_standard "01_Analysis" "Optimal objective <number>" 302 1e-6)
...
create_log_analysis(miplib2000_acc-tight5_mps_vol_standard "01_Analysis" "Optimal objective <number>" 0 1e-6)
...
create_log_analysis(miplib2000_aflow40b_mps_vol_standard "01_Analysis" "Optimal objective <number>" 1168 1e-6)
...
create_log_analysis(miplib2000_air04_mps_vol_standard "01_Analysis" "Optimal objective <number>" 56137 1e-6)
...
create_log_analysis(miplib2000_app1-2_mps_vol_standard "01_Analysis" "Optimal objective <number>" -41 1e-6)
...
create_log_analysis(miplib2000_bab5_mps_vol_standard "01_Analysis" "Optimal objective <number>" -106411.8401 1e-6)
...
create_log_analysis(miplib2000_beasleyC3_mps_vol_standard "01_Analysis" "Optimal objective <number>" 754 1e-6)
...
create_log_analysis(miplib2000_biella1_mps_vol_standard "01_Analysis" "Optimal objective <number>" 3065005.78 1e-6)
...
create_log_analysis(miplib2000_bienst2_mps_vol_standard "01_Analysis" "Optimal objective <number>" 54.6 1e-6)
...
create_log_analysis(miplib2000_binkar10_1_mps_vol_standard "01_Analysis" "Optimal objective <number>" 6742.200024 1e-6)
...
create_log_analysis(miplib2000_bley_xl1_mps_vol_standard "01_Analysis" "Optimal objective <number>" 190 1e-6)
...
create_log_analysis(miplib2000_bnatt350_mps_vol_standard "01_Analysis" "Optimal objective <number>" 0 1e-6)
...
create_log_analysis(miplib2000_core2536-691_mps_vol_standard "01_Analysis" "Optimal objective <number>" 689 1e-6)
...
create_log_analysis(miplib2000_cov1075_mps_vol_standard "01_Analysis" "Optimal objective <number>" 20 1e-6)
...
create_log_analysis(miplib2000_csched010_mps_vol_standard "01_Analysis" "Optimal objective <number>" 408 1e-6)
...
create_log_analysis(miplib2000_danoint_mps_vol_standard "01_Analysis" "Optimal objective <number>" 65.666667 1e-6)
...
create_log_analysis(miplib2000_dfn-gwin-UUM_mps_vol_standard "01_Analysis" "Optimal objective <number>" 38752 1e-6)
...
create_log_analysis(miplib2000_eil33-2_mps_vol_standard "01_Analysis" "Optimal objective <number>" 934.007916 1e-6)
...
create_log_analysis(miplib2000_eilB101_mps_vol_standard "01_Analysis" "Optimal objective <number>" 1216.920174 1e-6)
...
create_log_analysis(miplib2000_enlight13_mps_vol_standard "01_Analysis" "Optimal objective <number>" 71 1e-6)
...
create_log_analysis(miplib2000_ex9_mps_vol_standard "01_Analysis" "Optimal objective <number>" 81 1e-6)
...
create_log_analysis(miplib2000_glass4_mps_vol_standard "01_Analysis" "Optimal objective <number>" 1200012600 1e-6)
...
create_log_analysis(miplib2000_gmu-35-40_mps_vol_standard "01_Analysis" "Optimal objective <number>" -2406733.3688 1e-6)
...
create_log_analysis(miplib2000_iis-100-0-cov_mps_vol_standard "01_Analysis" "Optimal objective <number>" 29 1e-6)
...
create_log_analysis(miplib2000_iis-bupa-cov_mps_vol_standard "01_Analysis" "Optimal objective <number>" 36 1e-6)
...
create_log_analysis(miplib2000_iis-pima-cov_mps_vol_standard "01_Analysis" "Optimal objective <number>" 33 1e-6)
...
create_log_analysis(miplib2000_lectsched-4-obj_mps_vol_standard "01_Analysis" "Optimal objective <number>" 4 1e-6)
...
create_log_analysis(miplib2000_m100n500k4r1_mps_vol_standard "01_Analysis" "Optimal objective <number>" -25 1e-6)
...
create_log_analysis(miplib2000_macrophage_mps_vol_standard "01_Analysis" "Optimal objective <number>" 374 1e-6)
...
create_log_analysis(miplib2000_map18_mps_vol_standard "01_Analysis" "Optimal objective <number>" -847 1e-6)
...
create_log_analysis(miplib2000_map20_mps_vol_standard "01_Analysis" "Optimal objective <number>" -922 1e-6)
...
create_log_analysis(miplib2000_mcsched_mps_vol_standard "01_Analysis" "Optimal objective <number>" 211913 1e-6)
...
create_log_analysis(miplib2000_mik-250-1-100-1_mps_vol_standard "01_Analysis" "Optimal objective <number>" -66729 1e-6)
...
create_log_analysis(miplib2000_mine-166-5_mps_vol_standard "01_Analysis" "Optimal objective <number>" -566395707.870830059 1e-6)
...
create_log_analysis(miplib2000_mine-90-10_mps_vol_standard "01_Analysis" "Optimal objective <number>" -784302337.633172989 1e-6)
...
create_log_analysis(miplib2000_msc98-ip_mps_vol_standard "01_Analysis" "Optimal objective <number>" 19839497.0058740 1e-6)
...
create_log_analysis(miplib2000_mspp16_mps_vol_standard "01_Analysis" "Optimal objective <number>" 363 1e-6)
...
create_log_analysis(miplib2000_mzzv11_mps_vol_standard "01_Analysis" "Optimal objective <number>" -21718 1e-6)
...
create_log_analysis(miplib2000_n3div36_mps_vol_standard "01_Analysis" "Optimal objective <number>" 131000 1e-6)
...
create_log_analysis(miplib2000_n3seq24_mps_vol_standard "01_Analysis" "Optimal objective <number>" 52200 1e-6)
...
create_log_analysis(miplib2000_n4-3_mps_vol_standard "01_Analysis" "Optimal objective <number>" 8993 1e-6)
...
create_log_analysis(miplib2000_neos-1109824_mps_vol_standard "01_Analysis" "Optimal objective <number>" 378 1e-6)
...
create_log_analysis(miplib2000_neos-1337307_mps_vol_standard "01_Analysis" "Optimal objective <number>" -202319 1e-6)
...
create_log_analysis(miplib2000_neos-1396125_mps_vol_standard "01_Analysis" "Optimal objective <number>" 3000.045337 1e-6)
...
create_log_analysis(miplib2000_neos13_mps_vol_standard "01_Analysis" "Optimal objective <number>" -95.474807 1e-6)
...
create_log_analysis(miplib2000_neos-1601936_mps_vol_standard "01_Analysis" "Optimal objective <number>" 3 1e-6)
...
create_log_analysis(miplib2000_neos18_mps_vol_standard "01_Analysis" "Optimal objective <number>" 18 1e-6)
...
create_log_analysis(miplib2000_neos-476283_mps_vol_standard "01_Analysis" "Optimal objective <number>" 406.363207 1e-6)
...
create_log_analysis(miplib2000_neos-686190_mps_vol_standard "01_Analysis" "Optimal objective <number>" 6730 1e-6)
...
create_log_analysis(miplib2000_neos-849702_mps_vol_standard "01_Analysis" "Optimal objective <number>" 0 1e-6)
...
create_log_analysis(miplib2000_neos-916792_mps_vol_standard "01_Analysis" "Optimal objective <number>" 31.870398 1e-6)
...
create_log_analysis(miplib2000_neos-934278_mps_vol_standard "01_Analysis" "Optimal objective <number>" 260 1e-6)
...
create_log_analysis(miplib2000_net12_mps_vol_standard "01_Analysis" "Optimal objective <number>" 214 1e-6)
...
create_log_analysis(miplib2000_netdiversion_mps_vol_standard "01_Analysis" "Optimal objective <number>" 242 1e-6)
...
create_log_analysis(miplib2000_newdano_mps_vol_standard "01_Analysis" "Optimal objective <number>" 65.666667 1e-6)
...
create_log_analysis(miplib2000_noswot_mps_vol_standard "01_Analysis" "Optimal objective <number>" -41 1e-6)
...
create_log_analysis(miplib2000_ns1208400_mps_vol_standard "01_Analysis" "Optimal objective <number>" 2 1e-6)
...
create_log_analysis(miplib2000_ns1688347_mps_vol_standard "01_Analysis" "Optimal objective <number>" 27 1e-6)
...
create_log_analysis(miplib2000_ns1758913_mps_vol_standard "01_Analysis" "Optimal objective <number>" -1454.671755 1e-6)
...
add_coin_vol_test(miplib2000_ns1830653_mps_vol_standard osi_vol
                  ${VOL_INSTANCES_DIR}/ns1830653.mps.gz           ${CMAKE_BINARY_DIR}/tests/miplib2000_ns1830653.log)
...
create_log_analysis(miplib2000_ns1830653_mps_vol_standard "01_Analysis" "Optimal objective <number>" 20622 1e-6)
...
create_log_analysis(miplib2000_opm2-z7-s2_mps_vol_standard "01_Analysis" "Optimal objective <number>" -10280 1e-6)
...
create_log_analysis(miplib2000_pg5_34_mps_vol_standard "01_Analysis" "Optimal objective <number>" -14339.353447 1e-6)
...
create_log_analysis(miplib2000_pigeon-10_mps_vol_standard "01_Analysis" "Optimal objective <number>" -9000 1e-6)
...
create_log_analysis(miplib2000_pw-myciel4_mps_vol_standard "01_Analysis" "Optimal objective <number>" 10 1e-6)
...
create_log_analysis(miplib2000_qiu_mps_vol_standard "01_Analysis" "Optimal objective <number>" -132.873137 1e-6)
...
create_log_analysis(miplib2000_rail507_mps_vol_standard "01_Analysis" "Optimal objective <number>" 174 1e-6)
...
create_log_analysis(miplib2000_ran16x16_mps_vol_standard "01_Analysis" "Optimal objective <number>" 3823 1e-6)
...
create_log_analysis(miplib2000_reblock67_mps_vol_standard "01_Analysis" "Optimal objective <number>" -34630648.438331999 1e-6)
...
create_log_analysis(miplib2000_rmatr100-p10_mps_vol_standard "01_Analysis" "Optimal objective <number>" 423 1e-6)
...
create_log_analysis(miplib2000_rmatr100-p5_mps_vol_standard "01_Analysis" "Optimal objective <number>" 976 1e-6)
...
create_log_analysis(miplib2000_rmine6_mps_vol_standard "01_Analysis" "Optimal objective <number>" -457.186140000 1e-6)
...
create_log_analysis(miplib2000_rocII-4-11_mps_vol_standard "01_Analysis" "Optimal objective <number>" -6.65275566 1e-6)
...
create_log_analysis(miplib2000_rococoC10-001000_mps_vol_standard "01_Analysis" "Optimal objective <number>" 11460 1e-6)
...
create_log_analysis(miplib2000_roll3000_mps_vol_standard "01_Analysis" "Optimal objective <number>" 12890 1e-6)
...
create_log_analysis(miplib2000_satellites1-25_mps_vol_standard "01_Analysis" "Optimal objective <number>" -5 1e-6)
...
create_log_analysis(miplib2000_sp98ic_mps_vol_standard "01_Analysis" "Optimal objective <number>" 449144758.399999976 1e-6)
...
create_log_analysis(miplib2000_sp98ir_mps_vol_standard "01_Analysis" "Optimal objective <number>" 219676790.400000006 1e-6)
...
create_log_analysis(miplib2000_tanglegram1_mps_vol_standard "01_Analysis" "Optimal objective <number>" 5182 1e-6)
...
create_log_analysis(miplib2000_tanglegram2_mps_vol_standard "01_Analysis" "Optimal objective <number>" 443 1e-6)
...
create_log_analysis(miplib2000_timtab1_mps_vol_standard "01_Analysis" "Optimal objective <number>" 764772 1e-6)
...
create_log_analysis(miplib2000_triptim1_mps_vol_standard "01_Analysis" "Optimal objective <number>" 22.8681 1e-6)
...
create_log_analysis(miplib2000_unitcal_7_mps_vol_standard "01_Analysis" "Optimal objective <number>" 19635558.244019002 1e-6)
...
create_log_analysis(miplib2000_vpphard_mps_vol_standard "01_Analysis" "Optimal objective <number>" 5 1e-6)
...
create_log_analysis(miplib2000_zib54-UUE_mps_vol_standard "01_Analysis" "Optimal objective <number>" 10334015.82 1e-6)
