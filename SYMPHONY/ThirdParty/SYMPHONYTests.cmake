...
create_log_analysis(netlib_forplan_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_forplan_symphony.log "Optimal objective <number>" -664.21873953 1e-6)
...
create_log_analysis(netlib_ship08s_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_ship08s_symphony.log "Optimal objective <number>" 1920098.2105 1e-6)
...
create_log_analysis(netlib_fit1d_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_fit1d_symphony.log "Optimal objective <number>" -9146.3780924 1e-6)
...
create_log_analysis(netlib_brandy_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_brandy_symphony.log "Optimal objective <number>" 1518.5098965 1e-6)
...
create_log_analysis(netlib_scfxm1_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scfxm1_symphony.log "Optimal objective <number>" 18416.759028 1e-6)
...
create_log_analysis(netlib_grow22_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_grow22_symphony.log "Optimal objective <number>" -160834336.48 1e-6)
...
create_log_analysis(netlib_bandm_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_bandm_symphony.log "Optimal objective <number>" -158.62801845 1e-6)
...
create_log_analysis(netlib_fit1p_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_fit1p_symphony.log "Optimal objective <number>" 9146.3780924 1e-6)
...
create_log_analysis(netlib_standata_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_standata_symphony.log "Optimal objective <number>" 1257.6995000 1e-6)
...
create_log_analysis(netlib_pilot4_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_pilot4_symphony.log "Optimal objective <number>" -2581.1392641 1e-6)
...
create_log_analysis(netlib_stocfor2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_stocfor2_symphony.log "Optimal objective <number>" -39024.408538 1e-6)
...
create_log_analysis(netlib_sctap1_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sctap1_symphony.log "Optimal objective <number>" 1412.2500000 1e-6)
...
create_log_analysis(netlib_scrs8_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scrs8_symphony.log "Optimal objective <number>" 904.29998619 1e-6)
...
create_log_analysis(netlib_sctap2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sctap2_symphony.log "Optimal objective <number>" 1724.8071429 1e-6)
...
create_log_analysis(netlib_pilot87_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_pilot87_symphony.log "Optimal objective <number>" 301.71072827 1e-6)
...
create_log_analysis(netlib_greenbea_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_greenbea_symphony.log "Optimal objective <number>" -72462405.908 1e-6)
...
create_log_analysis(netlib_woodw_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_woodw_symphony.log "Optimal objective <number>" 1.3044763331 1e-6)
...
create_log_analysis(netlib_recipe_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_recipe_symphony.log "Optimal objective <number>" -266.61600000 1e-6)
...
create_log_analysis(netlib_share1b_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_share1b_symphony.log "Optimal objective <number>" -76589.318579 1e-6)
...
create_log_analysis(netlib_tuff_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_tuff_symphony.log "Optimal objective <number>" 0.29214776509 1e-6)
...
create_log_analysis(netlib_share2b_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_share2b_symphony.log "Optimal objective <number>" -415.73224074 1e-6)
...
create_log_analysis(netlib_bore3d_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_bore3d_symphony.log "Optimal objective <number>" 1373.0803942 1e-6)
...
create_log_analysis(netlib_d2q06c_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_d2q06c_symphony.log "Optimal objective <number>" 122784.23615 1e-6)
...
create_log_analysis(netlib_sc50b_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sc50b_symphony.log "Optimal objective <number>" -70 1e-6)
...
create_log_analysis(netlib_pilot_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_pilot_symphony.log "Optimal objective <number>" -557.40430007 1e-6)
...
create_log_analysis(netlib_bnl1_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_bnl1_symphony.log "Optimal objective <number>" 1977.6292856 1e-6)
...
create_log_analysis(netlib_ship04l_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_ship04l_symphony.log "Optimal objective <number>" 1793324.5380 1e-6)
...
create_log_analysis(netlib_sc105_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sc105_symphony.log "Optimal objective <number>" -52.202061212 1e-6)
...
create_log_analysis(netlib_boeing2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_boeing2_symphony.log "Optimal objective <number>" -315.01872802 1e-6)
...
create_log_analysis(netlib_nesm_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_nesm_symphony.log "Optimal objective <number>" 14076073.035 1e-6)
...
create_log_analysis(netlib_sc205_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sc205_symphony.log "Optimal objective <number>" -52.202061212 1e-6)
...
create_log_analysis(netlib_finnis_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_finnis_symphony.log "Optimal objective <number>" 172790.96547 1e-6)
...
create_log_analysis(netlib_degen2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_degen2_symphony.log "Optimal objective <number>" -1435.1780000 1e-6)
...
create_log_analysis(netlib_maros-r7_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_maros-r7_symphony.log "Optimal objective <number>" 1497185.1665 1e-6)
...
create_log_analysis(netlib_ship04s_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_ship04s_symphony.log "Optimal objective <number>" 1798714.7004 1e-6)
...
create_log_analysis(netlib_wood1p_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_wood1p_symphony.log "Optimal objective <number>" 1.4429024116 1e-6)
...
create_log_analysis(netlib_lotfi_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_lotfi_symphony.log "Optimal objective <number>" -25.264706062 1e-6)
set_tests_properties(netlib_lotfi_mps_symphony_standard_01_Analysis PROPERTIES LABELS "MPS")

add_coin_test(netlib_gfrd-pnc_mps_symphony_standard symphony
...
create_log_analysis(netlib_gfrd-pnc_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_gfrd-pnc_symphony.log "Optimal objective <number>" 6902235.9995 1e-6)
...
create_log_analysis(netlib_etamacro_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_etamacro_symphony.log "Optimal objective <number>" -755.71521774 1e-6)
...
create_log_analysis(netlib_grow7_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_grow7_symphony.log "Optimal objective <number>" -47787811.815 1e-6)
...
create_log_analysis(netlib_dfl001_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_dfl001_symphony.log "Optimal objective <number>" 112664396.05 1e-6)
...
create_log_analysis(netlib_agg_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_agg_symphony.log "Optimal objective <number>" -35991767.287 1e-6)
...
create_log_analysis(netlib_standgub_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_standgub_symphony.log "Optimal objective <number>" 1257.6995 1e-6)
...
create_log_analysis(netlib_ship12l_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_ship12l_symphony.log "Optimal objective <number>" 1470187.9193 1e-6)
...
create_log_analysis(netlib_standmps_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_standmps_symphony.log "Optimal objective <number>" 1406.0175000 1e-6)
...
create_log_analysis(netlib_scagr25_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scagr25_symphony.log "Optimal objective <number>" -14753433.061 1e-6)
...
create_log_analysis(netlib_capri_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_capri_symphony.log "Optimal objective <number>" 2690.0129138 1e-6)
...
create_log_analysis(netlib_cycle_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_cycle_symphony.log "Optimal objective <number>" -5.2263930249 1e-6)
...
create_log_analysis(netlib_greenbeb_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_greenbeb_symphony.log "Optimal objective <number>" -4302147.6065 1e-6)
...
create_log_analysis(netlib_agg2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_agg2_symphony.log "Optimal objective <number>" -20239252.356 1e-6)
...
create_log_analysis(netlib_stair_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_stair_symphony.log "Optimal objective <number>" -251.26695119 1e-6)
...
create_log_analysis(netlib_shell_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_shell_symphony.log "Optimal objective <number>" 1208825346.0 1e-6)
...
create_log_analysis(netlib_sierra_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sierra_symphony.log "Optimal objective <number>" 15394362.184 1e-6)
...
create_log_analysis(netlib_afiro_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_afiro_symphony.log "Optimal objective <number>" -464.75314286 1e-6)
...
create_log_analysis(netlib_scsd1_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scsd1_symphony.log "Optimal objective <number>" 8.6666666743 1e-6)
...
create_log_analysis(netlib_scsd8_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scsd8_symphony.log "Optimal objective <number>" 904.99999993 1e-6)
...
create_log_analysis(netlib_ship08l_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_ship08l_symphony.log "Optimal objective <number>" 1909055.2114 1e-6)
...
create_log_analysis(netlib_25fv47_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_25fv47_symphony.log "Optimal objective <number>" 5501.8458883 1e-6)
...
create_log_analysis(netlib_czprob_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_czprob_symphony.log "Optimal objective <number>" 2185196.6989 1e-6)
...
create_log_analysis(netlib_adlittle_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_adlittle_symphony.log "Optimal objective <number>" 225494.96316 1e-6)
...
create_log_analysis(netlib_d6cube_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_d6cube_symphony.log "Optimal objective <number>" 315.49166667 1e-6)
...
create_log_analysis(netlib_scorpion_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scorpion_symphony.log "Optimal objective <number>" 1878.1248227 1e-6)
...
create_log_analysis(netlib_sctap3_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sctap3_symphony.log "Optimal objective <number>" 1424.0 1e-6)
...
create_log_analysis(netlib_seba_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_seba_symphony.log "Optimal objective <number>" 15711.6 1e-6)
...
create_log_analysis(netlib_modszk1_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_modszk1_symphony.log "Optimal objective <number>" 320.61972906 1e-6)
...
create_log_analysis(netlib_pilotnov_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_pilotnov_symphony.log "Optimal objective <number>" -4497.2761882 1e-6)
...
create_log_analysis(netlib_beaconfd_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_beaconfd_symphony.log "Optimal objective <number>" 33592.485807 1e-6)
...
create_log_analysis(netlib_e226_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_e226_symphony.log "Optimal objective <number>" -18.751929066 1e-6)
...
create_log_analysis(netlib_degen3_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_degen3_symphony.log "Optimal objective <number>" -987.29400000 1e-6)
...
create_log_analysis(netlib_scfxm2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scfxm2_symphony.log "Optimal objective <number>" 36660.261565 1e-6)
...
create_log_analysis(netlib_fffff800_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_fffff800_symphony.log "Optimal objective <number>" 555679.61165 1e-6)
...
create_log_analysis(netlib_kb2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_kb2_symphony.log "Optimal objective <number>" -1749.9001299 1e-6)
...
create_log_analysis(netlib_ganges_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_ganges_symphony.log "Optimal objective <number>" -109586.36356 1e-6)
...
create_log_analysis(netlib_stocfor1_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_stocfor1_symphony.log "Optimal objective <number>" -41131.976219 1e-6)
...
create_log_analysis(netlib_scsd6_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scsd6_symphony.log "Optimal objective <number>" 50.500000078 1e-6)
...
create_log_analysis(netlib_80bau3b_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_80bau3b_symphony.log "Optimal objective <number>" 987232.16072 1e-6)
...
create_log_analysis(netlib_ship12s_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_ship12s_symphony.log "Optimal objective <number>" 1489236.1344 1e-6)
...
create_log_analysis(netlib_agg3_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_agg3_symphony.log "Optimal objective <number>" 10312115.935 1e-6)
...
create_log_analysis(netlib_maros_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_maros_symphony.log "Optimal objective <number>" -58063.743701 1e-6)
...
create_log_analysis(netlib_perold_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_perold_symphony.log "Optimal objective <number>" -9380.7580773 1e-6)
...
create_log_analysis(netlib_scagr7_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scagr7_symphony.log "Optimal objective <number>" -2331389.2548 1e-6)
...
create_log_analysis(netlib_scfxm3_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_scfxm3_symphony.log "Optimal objective <number>" 54901.254550 1e-6)
...
create_log_analysis(netlib_grow15_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_grow15_symphony.log "Optimal objective <number>" -106870941.29 1e-6)
...
create_log_analysis(netlib_fit2p_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_fit2p_symphony.log "Optimal objective <number>" 68464.293232 1e-6)
...
create_log_analysis(netlib_boeing1_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_boeing1_symphony.log "Optimal objective <number>" -335.21356751 1e-6)
...
create_log_analysis(netlib_sc50a_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_sc50a_symphony.log "Optimal objective <number>" -64.575077059 1e-6)
...
create_log_analysis(netlib_vtpbase_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_vtpbase_symphony.log "Optimal objective <number>" 129831.46246 1e-6)
...
create_log_analysis(netlib_blend_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_blend_symphony.log "Optimal objective <number>" -30.812149846 1e-6)
...
create_log_analysis(netlib_bnl2_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_bnl2_symphony.log "Optimal objective <number>" 1811.2365404 1e-6)
...
create_log_analysis(netlib_israel_mps_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/netlib_israel_symphony.log "Optimal objective <number>" -896644.82186 1e-6)
...
create_log_analysis(miplib3_10teams_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_10teams_symphony.log "Optimal objective <number>" 924 1e-6)
...
create_log_analysis(miplib3_air03_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_air03_symphony.log "Optimal objective <number>" 340160 1e-6)
...
create_log_analysis(miplib3_air04_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_air04_symphony.log "Optimal objective <number>" 56137 1e-6)
...
create_log_analysis(miplib3_air05_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_air05_symphony.log "Optimal objective <number>" 26374 1e-6)
...
create_log_analysis(miplib3_arki001_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_arki001_symphony.log "Optimal objective <number>" 7580813.0459 1e-6)
...
create_log_analysis(miplib3_bell3a_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_bell3a_symphony.log "Optimal objective <number>" 878430.32 1e-6)
...
create_log_analysis(miplib3_bell5_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_bell5_symphony.log "Optimal objective <number>" 8966406.49 1e-6)
...
create_log_analysis(miplib3_blend2_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_blend2_symphony.log "Optimal objective <number>" 7.598985 1e-6)
...
create_log_analysis(miplib3_cap6000_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_cap6000_symphony.log "Optimal objective <number>" -2451377 1e-6)
...
# not optimal - has stated in the miplib3 report
create_log_analysis(miplib3_dano3mip_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_dano3mip_symphony.log "Optimal objective <number>" 728.1111 1e-6)
...
create_log_analysis(miplib3_danoint_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_danoint_symphony.log "Optimal objective <number>" 65.67 1e-6)
...
create_log_analysis(miplib3_dcmulti_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_dcmulti_symphony.log "Optimal objective <number>" 188182 1e-6)
...
create_log_analysis(miplib3_dsbmip_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_dsbmip_symphony.log "Optimal objective <number>" -305.19817501 1e-6)
...
create_log_analysis(miplib3_egout_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_egout_symphony.log "Optimal objective <number>" 568.101 1e-6)
...
create_log_analysis(miplib3_enigma_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_enigma_symphony.log "Optimal objective <number>" 0.0 1e-6)
...
create_log_analysis(miplib3_fast0507_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_fast0507_symphony.log "Optimal objective <number>" 174 1e-6)
...
create_log_analysis(miplib3_fiber_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_fiber_symphony.log "Optimal objective <number>" 405935.18000 1e-6)
...
create_log_analysis(miplib3_fixnet6_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_fixnet6_symphony.log "Optimal objective <number>" 3983 1e-6)
...
create_log_analysis(miplib3_flugpl_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_flugpl_symphony.log "Optimal objective <number>" 1201500 1e-6)
...
create_log_analysis(miplib3_gen_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_gen_symphony.log "Optimal objective <number>" 112313 1e-6)
...
create_log_analysis(miplib3_gesa2_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_gesa2_symphony.log "Optimal objective <number>" 25779856.372 1e-6)
...
create_log_analysis(miplib3_gesa2_o_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_gesa2_o_symphony.log "Optimal objective <number>" 25779856.372 1e-6)
...
create_log_analysis(miplib3_gesa3_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_gesa3_symphony.log "Optimal objective <number>" 27991042.648 1e-6)
...
create_log_analysis(miplib3_gesa3_o_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_gesa3_o_symphony.log "Optimal objective <number>" 27991042.648 1e-6)
...
create_log_analysis(miplib3_gt2_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_gt2_symphony.log "Optimal objective <number>" 21166.000 1e-6)
...
create_log_analysis(miplib3_harp2_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_harp2_symphony.log "Optimal objective <number>" -73899798.00 1e-6)
...
create_log_analysis(miplib3_khb05250_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_khb05250_symphony.log "Optimal objective <number>" 106940226 1e-6)
...
create_log_analysis(miplib3_l152lav_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_l152lav_symphony.log "Optimal objective <number>" 4722 1e-6)
...
create_log_analysis(miplib3_lseu_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_lseu_symphony.log "Optimal objective <number>" 1120 1e-6)
...
create_log_analysis(miplib3_markshare1_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_markshare1_symphony.log "Optimal objective <number>" 1 1e-6)
...
create_log_analysis(miplib3_markshare2_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_markshare2_symphony.log "Optimal objective <number>" 1 1e-6)
...
create_log_analysis(miplib3_mas74_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_mas74_symphony.log "Optimal objective <number>" 11801.1857 1e-6)
...
create_log_analysis(miplib3_mas76_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_mas76_symphony.log "Optimal objective <number>" 4005.1 1e-6)
...
create_log_analysis(miplib3_misc03_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_misc03_symphony.log "Optimal objective <number>" 3360 1e-6)
...
create_log_analysis(miplib3_misc06_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_misc06_symphony.log "Optimal objective <number>" 12850.8607 1e-6)
...
create_log_analysis(miplib3_misc07_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_misc07_symphony.log "Optimal objective <number>" 2810 1e-6)
...
create_log_analysis(miplib3_mitre_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_mitre_symphony.log "Optimal objective <number>" 115155 1e-6)
...
# not optimal - has stated in the miplib3 report
create_log_analysis(miplib3_mkc_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_mkc_symphony.log "Optimal objective <number>" -553.75 1e-6)
...
create_log_analysis(miplib3_mod008_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_mod008_symphony.log "Optimal objective <number>" 307 1e-6)
...
create_log_analysis(miplib3_mod010_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_mod010_symphony.log "Optimal objective <number>" 6548 1e-6)
...
create_log_analysis(miplib3_mod011_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_mod011_symphony.log "Optimal objective <number>" -54558535 1e-6)
...
create_log_analysis(miplib3_modglob_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_modglob_symphony.log "Optimal objective <number>" 20740508 1e-6)
...
create_log_analysis(miplib3_noswot_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_noswot_symphony.log "Optimal objective <number>" -43 1e-6)
...
create_log_analysis(miplib3_nw04_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_nw04_symphony.log "Optimal objective <number>" 16862 1e-6)
...
create_log_analysis(miplib3_p0033_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_p0033_symphony.log "Optimal objective <number>" 3089 1e-6)
...
create_log_analysis(miplib3_p0201_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_p0201_symphony.log "Optimal objective <number>" 7615 1e-6)
...
create_log_analysis(miplib3_p0282_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_p0282_symphony.log "Optimal objective <number>" 258411 1e-6)
...
create_log_analysis(miplib3_p0548_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_p0548_symphony.log "Optimal objective <number>" 8691 1e-6)
...
create_log_analysis(miplib3_p2756_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_p2756_symphony.log "Optimal objective <number>" 3124 1e-6)
...
create_log_analysis(miplib3_pk1_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_pk1_symphony.log "Optimal objective <number>" 11.0 1e-6)
...
create_log_analysis(miplib3_pp08aCUTS_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_pp08aCUTS_symphony.log "Optimal objective <number>" 7350.0 1e-6)
...
create_log_analysis(miplib3_pp08a_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_pp08a_symphony.log "Optimal objective <number>" 7350.0 1e-6)
...
create_log_analysis(miplib3_qiu_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_qiu_symphony.log "Optimal objective <number>" -132.873137 1e-6)
...
create_log_analysis(miplib3_qnet1_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_qnet1_symphony.log "Optimal objective <number>" 16029.692681 1e-6)
...
create_log_analysis(miplib3_qnet1_o_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_qnet1_o_symphony.log "Optimal objective <number>" 16029.692681 1e-6)
...
create_log_analysis(miplib3_rentacar_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_rentacar_symphony.log "Optimal objective <number>" 30356761 1e-6)
...
create_log_analysis(miplib3_rgn_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_rgn_symphony.log "Optimal objective <number>" 82.1999 1e-6)
...
create_log_analysis(miplib3_rout_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_rout_symphony.log "Optimal objective <number>" 1077.56 1e-6)
...
create_log_analysis(miplib3_set1ch_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_set1ch_symphony.log "Optimal objective <number>" 54537.75 1e-6)
...
# not optimal - has stated in the miplib3 report
create_log_analysis(miplib3_seymour_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_seymour_symphony.log "Optimal objective <number>" 423 1e-6)
...
create_log_analysis(miplib3_stein27_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_stein27_symphony.log "Optimal objective <number>" 18 1e-6)
...
create_log_analysis(miplib3_stein45_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_stein45_symphony.log "Optimal objective <number>" 30 1e-6)
...
# not optimal - has stated in the miplib3 report
create_log_analysis(miplib3_swath_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_swath_symphony.log "Optimal objective <number>" 497.603 1e-6)
...
create_log_analysis(miplib3_vpm1_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_vpm1_symphony.log "Optimal objective <number>" 20 1e-6)
...
create_log_analysis(miplib3_vpm2_symphony_standard "01_Analysis" ${CMAKE_BINARY_DIR}/tests/miplib3_vpm2_symphony.log "Optimal objective <number>" 13.75 1e-6)
